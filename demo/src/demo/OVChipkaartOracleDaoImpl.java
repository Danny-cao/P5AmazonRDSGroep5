...
public class OVChipkaartOracleDaoImpl extends OracleBaseDao implements OVChipkaartDao {
	...
	public List<OVChipkaart> findAll() throws SQLException {
		...
		String getOVChipkaarten = "select kaartnummer, geldigtot, klasse, saldo, reiziger.reizigerid, voorletters, tussenvoegsel, achternaam, gebortedatum from ov_chipkaart, reiziger where ov_chipkaart.reizigerid = reiziger.reizigerid";
